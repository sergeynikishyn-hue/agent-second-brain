...
| Постановка учёта — Базовый (таблица ДДС+ОПиУ, дальше клиент сам) | 40–70 тыс₽ (разово) |
| Постановка учёта — Углублённый (ДДС+ОПиУ+Баланс+методология) | 150–250 тыс₽ (разово) |
| Постановка учёта — С сопровождением | цена уже определена пользователем (см. «Сопровождение») → [[thoughts/ideas/2026-08-02-shkala-tsen-postanovka-ucheta]] |
...
| 2026-08-02 | Определена 3-уровневая шкала цен для продукта «постановка учёта» (Базовый 40–70к / Углублённый 150–250к / С сопровождением — уже известна) | Закрывает open question из 2026-08-01 (рыночный анализ), нужна была срочно перед 2 консультациями 03.08 | Готовый прайс для завтрашних встреч → [[thoughts/ideas/2026-08-02-shkala-tsen-postanovka-ucheta]] |
