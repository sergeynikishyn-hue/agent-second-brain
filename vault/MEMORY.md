...
| 2026-08-02 | Воронка лидов (управленческий учёт): при поступлении нового лида автоматически создаётся задача «Связаться с [Имя]» | Решение пользователя — не терять входящие лиды без явной задачи в трекере | Процесс задокументирован в [[thoughts/ideas/2026-08-02-shablon-privetstvie-vhodyaschy-lid]]; первый прогон — [[thoughts/tasks/roman-svyazatsya-upravlenchesky-uchet]] |
