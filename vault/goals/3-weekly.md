...
- **Бот Telegram: достроить ветку «Диагностика»** — сейчас после нажатия кнопки диалог обрывается. Воронка прописана (контакты → короткий бриф → запись на консультацию), осталось реализовать (p1, поставлено 01.09) → [[thoughts/tasks/2026-09-01-bot-tg-voronka-diagnostika]]
